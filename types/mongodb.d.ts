...
export declare class Admin {
     ...
     */
    addUser(username: string, password?: string, options?: AddUserOptions, callback?: Callback<Document>): Promise<Document> | void;
    /**
     ...
     * @param callback An optional callback, a Promise will be returned if none is provided
     */
    removeUser(username: string, options?: RemoveUserOptions, callback?: Callback<boolean>): Promise<boolean> | void;
    /**
     ...
     * @returns {Promise<void> | void} returns Promise if no callback passed
     */
    validateCollection(collectionName: string, options?: any, callback?: Callback<Document>): Promise<Document> | void;
    /**
     ...
     * @returns {Promise<void> | void} returns Promise if no callback passed
     */
    listDatabases(options?: ListDatabasesOptions, callback?: Callback<string[]>): Promise<string[]> | void;
    /**
     ...
     * @returns {Promise<void> | void} returns Promise if no callback passed
     */
    replSetGetStatus(options?: CommandOperationOptions, callback?: Callback<Document>): Promise<Document> | void;
}
 ...
 */
export declare class AggregationCursor extends Cursor<AggregateOperation, AggregationCursorOptions> {
    constructor(topology: Topology, operation: AggregateOperation, options?: AggregationCursorOptions);
...
declare class ChangeStreamCursor extends Cursor<AggregateOperation, ChangeStreamCursorOptions> {
    ...
    constructor(topology: Topology, operation: AggregateOperation, options: ChangeStreamCursorOptions);
...
declare class ClientSession extends EventEmitter {
     ...
     */
    constructor(topology: Topology, sessionPool: ServerSessionPool, options: ClientSessionOptions, clientOptions?: MongoClientOptions);
...
export declare interface Collection {
    ...
    group(keys: any, condition: any, initial: any, reduce: any, finalize: any, command: any, options: any, callback: any): void;
    removeMany(filter: Document, options?: DeleteOptions, callback?: Callback<DeleteResult>): Promise<DeleteResult> | void;
...
export declare class Collection {
    ...
    insertMany(docs: Document[], options: InsertOptions_2, callback: Callback<InsertManyResult>): void;
    /**
    ...
    bulkWrite(operations: Document[], options: InsertOptions_2, callback: Callback<BulkWriteResult>): void;
    /**
    ...
    updateOne(filter: Document, update: Document, options: UpdateOptions_2, callback: Callback<UpdateResult>): void;
    /**
    ...
    replaceOne(filter: Document, replacement: Document, options: ReplaceOptions, callback: Callback<UpdateResult>): void;
    /**
    ...
    updateMany(filter: Document, update: Document, options: UpdateOptions_2, callback: Callback<UpdateResult>): void;
    /**
    ...
    createIndex(fieldOrSpec: string | Document, options: CreateIndexesOptions, callback: Callback<Document>): void;
    /**
...
declare class CommandOperation<T extends CommandOperationOptions = CommandOperationOptions> extends OperationBase<T> {
    ns: MongoDBNamespace;
...
declare interface CommandOperationOptions extends OperationOptions, BSONSerializeOptions {
    fullResponse?: boolean;
...
declare class Connection extends EventEmitter {
    ...
    query(ns: string, cmd: Document, cursorState: InternalCursorState, options: QueryOptions, callback: Callback): void;
    getMore(ns: string, cursorState: InternalCursorState, batchSize: number, options: GetMoreOptions, callback: Callback): void;
...
declare interface ConnectionOptions extends Partial<TcpNetConnectOpts>, Partial<IpcNetConnectOpts>, Partial<ConnectionOptions_2>, StreamDescriptionOptions {
    id: number;
    monitorCommands: boolean;
    generation: number;
...
declare interface ConnectionPool {
    isConnected(): boolean;
    write(message: any, commandOptions: any, callback: (err: MongoError, ...args: CommandResult[]) => void): void;
}
 ...
 */
declare class CoreCursor<O extends OperationBase = OperationBase, T extends CoreCursorOptions = CoreCursorOptions> extends Readable {
    operation: O;
    server?: Server;
    ns: string;
    namespace: MongoDBNamespace;
 ...
 */
export declare class Cursor<O extends OperationBase = OperationBase, T extends CursorOptions = CursorOptions> extends CoreCursor<O, T> {
    s: CursorPrivate;
    constructor(topology: Topology, operation: O, options?: T);
...
declare interface CursorPrivate {
    /** Transforms functions */
    transforms?: DocumentTransforms;
    numberOfRetries: number;
    tailableRetryInterval: number;
...
export declare class Db {
    ...
    executeDbAdminCommand(command: Document, options: RunCommandOptions, callback: Callback<void>): void;
    /**
    ...
    createIndex(name: string, fieldOrSpec: string | object, options: CreateIndexesOptions): Promise<Document>;
    createIndex(name: string, fieldOrSpec: string | object, options: CreateIndexesOptions, callback: Callback<Document>): void;
    /**
     * Add a user to the database
     *
     * @param username The username for the new user
 ...
 * });
 */
declare const FLAGS: readonly ["tailable", "oplogReplay", "noCursorTimeout", "awaitData", "exhaust", "partial"];
...
declare interface MongoClientOptions extends WriteConcernOptions, MongoURIOptions, BSONSerializeOptions {
 ...
 */
declare interface MongoURIOptions extends Pick<WriteConcernOptions, 'journal' | 'w' | 'wtimeoutMS'> {
...
declare type Parent = MongoClient | Db | Collection | {
    s: any;
};
...
declare type ReadPreferenceLike = ReadPreference | ReadPreferenceMode | keyof typeof ReadPreferenceMode;
...
declare class Server extends EventEmitter {
     ...
     * @param callback
     */
    query(ns: string, cmd: Document, cursorState: Partial<InternalCursorState>, options: QueryOptions, callback: Callback): void;
    /**
     ...
     * @param callback
     */
    getMore(ns: string, cursorState: InternalCursorState, batchSize: number, options: GetMoreOptions, callback: Callback2): void;
    /**
...
declare type SortDirection = 1 | -1 | 'asc' | 'desc' | {
    $meta: string;
};
 ...
 */
declare type WithConnectionCallback = (error: MongoError, connection: Connection | undefined, callback: Callback<Connection>) => void;
