 ...
 */
export declare class CommandCursor extends Cursor {
    /**
     * @param {any} topology
     * @param {any} operation
     * @param {any} [options]
 ...
 *
 * @callback resultCallback@callback resultCallback
 ...
 */
declare class CoreCursor extends Readable {
    operation: any;
    pool: any;
    server: any;
     ...
     * @param {Function} [callback]
     */
    _endSession(options?: any, callback?: Callback): boolean;
    _getMore(callback: Callback2): void;
    _initializeCursor(callback: Callback): void;
}

declare type CoreCursorOptions = BSONSerializeOptions;
 ...
 */
export declare class Cursor extends CoreCursor {
    /**
     * @param {any} topology
     * @param {any} operation
     * @param {any} [options]
     ...
     * The callback format for results
     *
     * @callback Cursor@callback Cursor~resultCallback
     * @param {MongoError} error An error instance representing the error during the execution.
     ...
     *
     * @callback Cursor@callback Cursor~iteratorCallback
     * @param {object} doc An emitted document for the iterator
     */
    /**
     * The callback error format for the forEach iterator method
     *
     * @callback Cursor@callback Cursor~endCallback
     * @param {MongoError} error An error instance representing the error during the execution.
     */
    /**
     ...
     * The callback format for results
     *
     * @callback Cursor@callback Cursor~toArrayResultCallback
     * @param {MongoError} error An error instance representing the error during the execution.
     ...
     * The callback format for results
     *
     * @callback Cursor@callback Cursor~countResultCallback
     * @param {MongoError} error An error instance representing the error during the execution.
     ...
     * @returns {Promise<void> | void} returns Promise if no callback passed
     */
    count(applySkipLimit?: boolean, options?: any, callback?: Callback<number>): Promise<number> | void;
    /**
     ...
     * @param {Function} [options.transform] A transformation method applied to each document emitted by the stream.
     */
    transformStream(options?: any): Transform;
    /**
...
export declare class ReadPreference {
     ...
     */
    static translate(options: any): any;
    /**
